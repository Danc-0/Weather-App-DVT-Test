...
class OpenWeatherRepositoryImpl @Inject constructor(private val service: OpenWeatherService, private val weatherDao: WeatherDao): OpenWeatherRepository {
    ...
    override suspend fun getCurrentWeatherForecast(lat: Double, long: Double, cnt: Int): CurrentWeatherForecast {
       return service.getCurrentWeatherForecast(lat, long, cnt)
    }
